  ...
  [k: string]: {
    ...
    function useChart() {
      ...
      function useChart() {
        ...
        export type ChartConfig = Record<string, { label?: React.ReactNode; icon?: React.ComponentType<any>; color?: string; theme?: Record<string, string> }>
        ...
        function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
          ...
          const data = p.payload && typeof p.payload === "object" ? p.payload : p
          const labelKey = (key in p && typeof p[key] === "string" ? p[key] : key) as string
          return (config as any)[labelKey] ?? (config as any)[key]
        }

        export const ChartTooltip = RechartsPrimitive.Tooltip

        export const ChartTooltipContent = React.forwardRef((props: TooltipProps<any, any> & { indicator?: "dot" | "line" | "dashed"; className?: string; hideIndicator?: boolean; nameKey?: string }, ref: any) => {
