    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: AnyPayload, index: number) => {
...
export const ChartLegendContent = React.forwardRef(
  (
    props: LegendProps & { hideIndicator?: boolean; indicator?: "dot" | "line" | "dashed"; className?: string },
    ref: any,
  ) => {
    ...
    return (
      ...
      >
        {payload.map((item: AnyPayload, i: number) => {
...
function getPayloadConfigFromPayload(config: ChartConfig, payload: unknown, key: string) {
  ...
  if (key in payloadAny && typeof payloadAny[key as keyof typeof payloadAny] === "string") {
    configLabelKey = payloadAny[key as keyof typeof payloadAny] as string
